...
can include line breaks.` // Same string type.
	...
	a4Cpy := a4                    // a4_cpy is a copy of a4, two separate instances.
	a4Cpy[0] = 25                  // Only a4_cpy is changed, a4 stays the same.
	...
	s3Cpy := s3                    // Both variables point to the same instance.
	s3Cpy[0] = 0                   // Which means both are updated.
...
func learnErrorHandling() {
	...
	if _, err := strconv.Atoi("non-int"); err != nil { // _ discardds value
		fmt.Println(err)
	}
...
// we''l use inc to increment some numbers concurrently.
